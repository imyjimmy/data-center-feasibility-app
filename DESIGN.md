...
- `MCP Agent Test Page`: `/mcp_test` page for sending a freeform prompt directly to the Pydantic AI agent with FastMCP tools attached. It displays the agent summary, provider insights, and MCP tool-call record.
